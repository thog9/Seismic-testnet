...
LANG = {
    'vi': {
        'title': '✨ TRIỂN KHAI HỢP ĐỒNG TIMER - SEISMIC TESTNET ✨',
        'info': 'ℹ Thông tin',
        'found': 'Tìm thấy',
        'wallets': 'ví',
        'processing_wallet': '⚙ XỬ LÝ VÍ',
        'checking_balance': 'Đang kiểm tra số dư...',
        'insufficient_balance': 'Số dư không đủ (cần ít nhất 0.001 ETH cho giao dịch)',
    ...
    'en': {
        'title': '✨ DEPLOY TIMER CONTRACT - SEISMIC TESTNET ✨',
        'info': 'ℹ Info',
        'found': 'Found',
        'wallets': 'wallets',
        'processing_wallet': '⚙ PROCESSING WALLET',
        'checking_balance': 'Checking balance...',
        'insufficient_balance': 'Insufficient balance (need at least 0.001 ETH for transaction)',
