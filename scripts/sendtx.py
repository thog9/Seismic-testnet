...
LANG = {
    'vi': {
        ...
        'amount_prompt': 'Số lượng ETH (mặc định 0.000001, tối đa 999): ',
        'amount_unit': 'ETH',
    ...
    'en': {
        ...
        'amount_prompt': 'Amount of ETH (default 0.000001, max 999): ',
        'amount_unit': 'ETH',
    ...
    for attempt in range(CONFIG['MAX_RETRIES']):
        try:
            ...
            if balance < required_balance:
                print(f"{Fore.RED}  ✖ {LANG[language]['insufficient_balance'].format(required=required_balance)}: {balance:.6f} ETH{Style.RESET_ALL}")
                return False
